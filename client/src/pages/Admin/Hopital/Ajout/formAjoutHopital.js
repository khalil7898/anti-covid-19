...
const FormAjoutHopital = () => {
  const { handleOnChange, handleSubmit, values, errors } = useFormAjoutHopital(
    submit,
    validationAjoutHopital
  );
            ...
            <div className="card-body">
              ...
              <form onSubmit={handleSubmit} noValidate>
                <div className="form-group row">
                  <label htmlFor="input-26" className="col-sm-2 col-form-label">
                    Name
                  </label>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    {errors.adressnom && (
                      <p className="error mt-1 ml-3">{errors.adressnom}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-lg-5 ">
                    <div className="input-group mb-3">
                      ...
                      />
                      {errors.longitude && (
                        <p className="error mt-1 ml-3">{errors.longitude}</p>
                      )}
                    </div>
                  </div>
                  <div className="col-lg-5">
                    <div className="input-group mb-3">
                      ...
                      />
                      {errors.latitude && (
                        <p className="error mt-1 ml-3">{errors.latitude}</p>
                      )}
                    </div>
                  </div>
                </div>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    {errors.telephone && (
                      <p className="error mt-1 ml-3">{errors.telephone}</p>
                    )}
                  </div>
                </div>

                <div className="form-group row">
                  <label htmlFor="input-28" className="col-sm-2 col-form-label">
                    Capacite total
                  </label>
                  <div className="col-sm-10">
                    <input
                    ...
                    {errors.capaciteTotal && (
                      <p className="error mt-1 ml-3">{errors.capaciteTotal}</p>
                    )}
                  </div>
                </div>
                <div className="form-group row">
                  <label htmlFor="input-29" className="col-sm-2 col-form-label">
                    capacite corona
                  </label>
                  <div className="col-sm-10">
                    <input
                    ...
                    {errors.capaciteCorona && (
                      <p className="error mt-1 ml-3">{errors.capaciteCorona}</p>
                    )}
                  </div>
                </div>
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    {errors.capaciteRea && (
                      <p className="error mt-1 ml-3">{errors.capaciteRea}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    {errors.totalCharger && (
                      <p className="error mt-1 ml-3">{errors.totalCharger}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    />
                    {errors.reacharger && (
                      <p className="error mt-1 ml-3">{errors.reacharger}</p>
                    )}
                  </div>
                </div>
                ...
                <div className="form-group row">
                  ...
                  <div className="col-sm-10">
                    ...
                    {errors.coronaCharger && (
                      <p className="error mt-1 ml-3">{errors.coronaCharger}</p>
                    )}
                  </div>
                </div>
